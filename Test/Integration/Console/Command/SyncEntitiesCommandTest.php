...
class SyncEntitiesCommandTest extends TestCase
{
    ...
    public function testExecute_Fails_ForCategories_AddAndUpdate(): void
    {
        ...
        $this->assertSame(expected: Cli::RETURN_FAILURE, actual: $isFailure, message: 'Entity Sync Successful');

        $display = $tester->getDisplay();
        $this->assertStringContainsString(
            needle: sprintf('Begin Entity Sync with filters: Entity Types = KLEVU_CMS, API Keys = %s', $apiKey),
            haystack: $display,
        );
        $this->assertStringContainsString(
        ...
        $pattern = '#Action: KLEVU_CMS::delete#';
        $matches = [];
        preg_match(
            pattern: $pattern,
            subject: $display,
        ...
        $this->assertCount(0, $matches, 'KLEVU_CMS::delete batches');
    ...
    public function testExecute_Succeeds_ForCategories_Delete(): void
    {
        ...
        $this->assertCount(0, $matches, 'KLEVU_CMS::add batches');
        ...
        $pattern = '#Action: KLEVU_CMS::update#';
        $matches = [];
        preg_match(
            pattern: $pattern,
            subject: $display,
        ...
        $this->assertCount(0, $matches, 'KLEVU_CMS::update batches');
